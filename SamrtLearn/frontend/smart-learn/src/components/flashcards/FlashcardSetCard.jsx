...
const FlashcardSetCard = ({flashcardSet}) => {
    ...
    const handleStudyNow = () => {
        navigate(`/document/${flashcardSet.documzntId._id}/flashcards`);
    };
    ...
    return (
        <div 
            className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300  rounded-2xl p-6 cursor-pointer transtion-all duration-200 hover:shadow-lg hover:shadow-emerald-500/50 flex flex-col justify-between"
        ...
        >
            <div className="space-y-4">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-8">
                        <h3 className="text-base font-semibold text-slate-900 line-clamp-2 mb-1" title={flashcardSet?.documzntId?.title}>
                            {flashcardSet?.documzntId?.title}
                        </h3>
            ...
            <div className="mt-6 pt-4 border-t border-slate-100">
                <button
                    ...
                    className="group/btn relative w-full h-11 bg-linear-to-r from-emerald-50 to-teal-100 hover:from-emerald-600 hover:to-teal-700 hover:text-white font-semibold text-sm rounded-xl transition-all durzation-200 active:scale-95 overflow-hidden"
                >
