...
import { FileText, BookOpen, BrainCircuit, Clock, TrendingUp} from 'lucide-react';
  ...
  const stats = [
    {
      ...
      icon: FileText,
      grandient: 'from-blue-400 to-cyan-500',
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="group relative bg-white/80 backdrop-blur-xl border vorder-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300 hover:-translate-y-1"
            >
        ...
        <div className="bg-white/80 backdrop-lur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
