...
const DocumentListPage = () =>{
  ...
  const handleUpload = async (e) => {
    ...
    console.log("Instanceof File:", uploadFile instanceof File);
  ...
  return (
    <div className="min-h-screen">
      ...
      {isDeleteModalOpen && (
      <div className="fixed inset-0 z-50 flex items-center jusitfy-center p-4 bg-slate-900/50 backdrop-blur-sm">
        <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-slate-900/20 p-6">
          <button 
