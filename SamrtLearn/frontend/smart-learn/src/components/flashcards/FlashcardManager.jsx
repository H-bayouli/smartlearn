...
const FlashcardManager = ({documentId}) => {
    ...
    const handleConfirmDelete = async () => {
        ...
        setDeleting(true);
        try{
            await flashcardService.deleteFlashcarSet(setToDelete._id);
            ...
            <div className='space-y-8'>
                ...
                <div className='flex flex-col items-center space-y-8'>
                    ...
                    <div className='flex items-center gap-6'>
                        ...
                        >
                            <ChevronLeft
                                className='w-4 h-4 group-hover:-translate-x-0.5 transtion-transform duration-200'
                                strokeWidth={2.5}
                            />
                            Previous 
                        </button>
                        ...
                        <button
                            ...
                            disabled={selectedSet.cards.length <= 1}
                            className='group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transtion-all duration-200 disabled:opactiy-40 disabled:cursor-not-allowed disabled:hover:bg-slate-200'
                        >
                            Next 
                            <ChevronRight
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
                    {flashcardSets.map((set) => (
                        <div
                            ...
                            className='group relative bg-white/80 background-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10'
                        >
                            <button
                            ...
                            <div className='space-y-4'>
                                ...
                                <div>
                                    ...
                                    <p className='text-xs font-medium text-slate-500 uppercase tracking-width'>
    ...
    return (
        <>
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-xl shadow-slate-200/50 p-8'>
        ...
        >
            <div className='space-y-6'>
                <p className='text-sm text-slate-600'>
                    Are you sure you want to dekete this flashcard set? This action 
                ...
                <div className='flex items-center justify-end gap-3 pt-2'>
                    <button
                        ...
                        disabled={deleting}
                        className='px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium tex-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed'
                    >
                        Cancel 
                    </button>
                    <button
